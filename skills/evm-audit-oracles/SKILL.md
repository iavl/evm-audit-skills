...
4. Resolve `domain-resolution.json`; then rerun Screen with `--domain-resolution <run-dir>/reviews/domain-resolution.json --screen-results-out <run-dir>/reviews/screen-results.json --output <run-dir>/runtime/screen-evm-audit-oracles.md`.
...
6. `python3 <suite-root>/scripts/render_runtime.py --manifest <run-dir>/routing/manifest.json --profile deep --domain-resolution <run-dir>/reviews/domain-resolution.json --screen-results <run-dir>/reviews/screen-results.json --owner-domain evm-audit-oracles --output <run-dir>/runtime/deep-evm-audit-oracles.md`
